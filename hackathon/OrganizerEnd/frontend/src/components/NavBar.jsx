        ...
        <div className="bg-gray-900/15 backdrop-blur-3xl font-extrabold text-gray-200 text-xl p-5 border-b border-green-500/30">
            <div className="flex justify-between max-w-full mx-auto">
                ...
                <div className="flex gap-6 items-center">
                    <div>
                        <Link to={"/organizerdashboard"}className="text-gray-200 hover:text-green-300 transition-colors duration-300">Home</Link>
                    </div>
                    <div>
                        <Link to={"/postHack"} className="text-gray-200 hover:text-green-300 transition-colors duration-300"> Events</Link>
                    </div>
                    <div>
                        <button 
                            onClick={() => {
